...
const routes: Routes = [
  ...
  // players
  // TODO
  // path: 'players/:id' => redirect 'players/:id/bio'
  // path: 'players/:id/bio' => PlayerDetailsComponent
  // path: 'players/:id/stats' => PlayerStatsComponent
  // path: 'players' => PlayerListComponent
